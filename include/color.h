...
#define _COLOR_H
//集成
#define LIB_PERFIX "[hb719]"
#define LIB_DBG LIB_PERFIX RED"Debug:"_COLOR
#define LIB_INF LIB_PERFIX GREEN"Info:"_COLOR
#define LIB_WAR LIB_PERFIX YELLOW"Warning:"_COLOR
#define LIB_ERR LIB_PERFIX RED"Error:"_COLOR
#endif
